...
```
As can be seen from the plot below `r max_5_min`th 5-minute interval contains the maximum number of steps
...
Total number of missing values in the dataset is `r count_na`.
